...
def initialize():
    try:
        ...
        print("[*] Failes when intializing. Please report this issue to ANUB!NGUS")
...
def get_members_latest_acticity(driver, tickrange, ticklength):
    try:
        ...
        print("[*] Failed to get member list. Please report this issue to ANUB!NGUS")
...
def visit_profiles(links, driver): 
    try:       
        ...
        print("[*] Failed when visiting profiles. Please report this issue to ANUB!NGUS")
...
def marketplace_messager():
    try:        
        ...
        print("[*] Failed to initialize marketplace messanger thread. Please report this issue to ANUB!NGUS")
